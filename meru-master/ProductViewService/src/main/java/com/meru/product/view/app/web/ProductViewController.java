package com.meru.product.view.app.web;
...
import com.meru.product.view.app.service.ProductViewServiceIntf;
...
public class ProductViewController {
    ...
    public ResponseEntity<ProductViewModel> getProductViewById(@PathVariable int id) {
    	ProductViewModel pvm = pvs.getProductViewById(id);
    ...
    public ResponseEntity<List<ProductViewModel>> getAllProductViews() {
